...
<body>
    ...
    try {
        ...
        $queryItems  = $conn->query('
            ...
            ORDER BY mg.zoneid, mob_name, item_name ASC;');
        $i = 0;
    ...
    <script>
        ...
        // ZONE GLOBAL (needs to be moved somewhere else)
        ZONEID = {
            // 0
            1: 'Phanauet Channel',
            ...
            227: 'Ship bound for Selbina (with Pirates)',
            228: 'Ship bound for Mhaura (with Pirates)',
            // 229
