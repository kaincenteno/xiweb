...
h3.innerHTML = `Vana'diel time is now: ${vanatime['year']}/${String(vanatime['month']).padStart(2, "0")}/${String(vanatime['day']).padStart(2, "0")} - ${String(vanatime['hour']).padStart(2, "0")}:${String(vanatime['minute']).padStart(2, "0")}`
